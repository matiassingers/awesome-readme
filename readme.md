...
-[varuogm/My-snap-creations](https://github.com/varuogm/My-snap-creations#readme) - Clear readme with example screenshot for quick demo of gifs. Multiple badges, Color coordinated,colorful and simple interface, GIF demo.
