...
- [aregtech/areg-sdk](https://github.com/aregtech/areg-sdk#readme) - Logo. Multiple info and statistics badges. Brief description. List of contributors and stargazers with pictures. TOC and "Back to top" link for easy navigation. Headlines with graphics. Topic hide/show menu. Project philosophy. Clone instructions. Quick build with multiple tools. Integration instruction. Tools configuration instructions. Reference to the examples. Reference to use cases. References to guidance and Wiki pages. Links with badges to contact. Links with badges to share project in social network.
