...
- [jdjuan/ng-notyf](https://github.com/jdjuan/ng-notyf) - Customized badges. GIF demo. Well placed emoticons. Concise description. Concise instructions with examples to use in your project.
