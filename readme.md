...
- [iterative/dvc](https://github.com/iterative/dvc) - ReStructuredText format examplem PyPi compatible. Logo, custom website-like menu. Smooth how-it-works animation. Badges. Nice contribution section with the hall-of-fame.
