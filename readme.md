...
- [adamlui/ai-web-extensions](https://github.com/adamlui/ai-web-extensions#readme) - Striking header, organized CTAs, expandable descriptions for screenshots, direct web store links for quick, clutter-free navigation.
...
- [KudoAI/chatgpt.js](https://github.com/KudoAI/chatgpt.js#readme) - Language selector, project logo, clear description, informative shields, multi-platform step-by-step import instructions, usage examples, demo video, showcase project links, screenshots, contributor & partner logos.
