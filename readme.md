...
- [motdotla/dotenv](https://github.com/motdotla/dotenv#readme) - Logo with description, then straight into installation and usage. Additionally a good example of recognizing sponsors without distracting from the README contents - clear separation.
