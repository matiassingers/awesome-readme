...
- [armync/arminc-autoexec](https://github.com/ArmynC/ArminC-AutoExec/) - Project Logo, Badges, Table of Contents, Descriptions, Installation and Updating Steps (subcategories), Features (comparisons table), Wiki and Contributing (articles), Author, Support, Donate and License. 
