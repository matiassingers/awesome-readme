...
- [antonioFalcaoJr/eda.cleanArch.ddd.cqrs.eventsourcing](https://github.com/AntonioFalcaoJr/EDA.CleanArch.DDD.CQRS.EventSourcing#readme) - The project has a well-defined logo, has well-defined sections such as: About the project, The architectural solution, and all the reference links such as articles, videos, and documentation, it explains how to run the project in different environments (development and production), it has documented load tests, it also describes which technologies are used, it has diagrams for the archetype.
