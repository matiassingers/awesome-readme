...
- [adamlui/minify.js](https://github.com/adamlui/minify.js#readme) - Clear description, informative shields, elucidative screenshot, multi-purpose installation instructions, command line examples for different use cases, table of CLI options, API usage instructions, method parameter tables, MIT license text, links to related utillities.
