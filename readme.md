...
- [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet/#readme) - Clear description, easy on-boarding exprience, string forward quickstart deployment with guided self-hosted docs and community support references.
