...
- [Reseter.css] - Multiple Badges, Feature List, Project Logo, Concise Description, Usage Section, TOC, Easy to follow instructions for local development set up, Easy installation/use instructions.
