...
- [coolreadme.xyz](https://coolreadme.xyz) - Embeddable animated SVG cards for project READMEs. Display live npm stats, install commands, and documentation as edge-rendered cards. No auth required.
