...
- [IvanStoychev/IvanStoychev.StringExtensions](https://github.com/IvanStoychev/IvanStoychev.StringExtensions#readme) - Project banner. Table of contents. Informative badges (activity, release, license). Community section. Easy navigation. Colorful icons in front of titles. Key features, listed with examples. Clear description of what the project does. Simple and detailed installation instructions. Great wiki documentation.
- [IvanStoychev/Visual-Studio-Templates-and-Snippets](https://github.com/IvanStoychev/Visual-Studio-Templates-and-Snippets#readme) - Project banner. Table of contents. Informative badges (activity, release, license). Community section. Easy navigation. Colorful icons in front of titles. Key features. Clear description of what the project does. Simple and detailed installation instructions. Great wiki documentation.
